-- =====================================================
-- SCHEMA SUPABASE POUR VINTED PRO
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_ventes_article_id ON ventes(article_id);
...
INSERT INTO inventaire (user_id, nom, categorie, etat, prix, cout, statut, vues, likes)
VALUES 
  ('your-user-id-here', 'Robe Zara fleurie', 'Vêtements', 'Très bon état', 25, 5, 'En vente', 156, 23),
  ('your-user-id-here', 'Sneakers Nike Air Max', 'Chaussures', 'Très bon état', 65, 15, 'En vente', 89, 12),
  ('your-user-id-here', 'Sac Louis Vuitton', 'Sacs', 'Très bon état', 120, 30, 'Vendu', 234, 45);
*/ 