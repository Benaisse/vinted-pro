        ...
        <div className="flex flex-col sm:flex-row gap-3 lg:flex-shrink-0">
          ...
          {primaryAction && (
            <Button
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2"
            >
