    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200 shadow-sm"
        >
            ...
            <nav className="flex space-x-8 px-6">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex items-center gap-2 py-4 px-1 border-b-2 font-medium text-sm transition-all duration-200 hover:scale-105 ${
                    activeTab === tab.id
